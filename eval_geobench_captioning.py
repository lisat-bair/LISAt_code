...
def main():
    ...
    parser.add_argument('--prediction_file', default="/home/wenhan/Projects/sesame/pred_genbench/lisat_0223_v1/pred_geobench_captioning.json", type=str, required=True, help='Path to the prediction JSONL file.')
    parser.add_argument('--answer_file', default="/home/wenhan/Projects/sesame/dataset/GEOBench-VLM/Captioning/qa.json",type=str, required=True, help='Path to the answer JSONL file.')
