...
def parse_args(args):
    ...
    parser.add_argument("--pretrained_model_path", default="/home/wenhan/Projects/sesame/runs/geo_0110/hg_model")
    #parser.add_argument("--pretrained_model_path", default="xinlai/LISA-13B-llama2-v1")
    parser.add_argument("--vis_save_dir", default="./demo_directory/geo_0110", type=str)
    #parser.add_argument("--vis_save_dir", default="./demo_directory/LISA-13B-llama2-v1", type=str)
